...
const DRAW_SCENES = [
  ...
  const WHYS = [
    ...
    /* ---------- 以下为扩充题库（不与原 43 条重复），合计约 121 条 ---------- */
    /* 动物 */
    { q:"兔子为什么爱吃胡萝卜？", a:"胡萝卜脆脆甜甜，还有对眼睛好的营养；兔子门牙长得快，啃硬硬的东西还能帮它磨牙。" },
    { q:"鱼为什么睁着眼睛睡觉？", a:"鱼没有眼皮，眼睛一直睁着；它睡觉时躲在水草里慢慢游，只是不像我们那样闭眼。" },
    { q:"小狗为什么爱摇尾巴？", a:"尾巴是小狗的语言：摇尾巴表示开心、友好，见到你它就想说『我好高兴！』" },
    { q:"长颈鹿的脖子为什么那么长？", a:"长颈鹿的祖先里，脖子长的能吃到高处的叶子，活得更好、宝宝更多，慢慢地脖子就都变长啦。" },
    { q:"蛇为什么总吐舌头？", a:"蛇的舌头能尝到空气里的味道，帮它找食物、认路，吐进吐出其实是在闻味道呢。" },
    { q:"企鹅为什么不怕冷？", a:"企鹅身上有厚厚的羽毛和脂肪小棉袄，又常常挤成一团互相取暖，所以南极它也不怕。" },
    { q:"乌龟为什么背着重重的壳？", a:"壳是乌龟的家和铠甲，遇到危险就缩进去，硬硬的壳能挡住大多数敌人。" },
    { q:"马为什么站着睡觉？", a:"野马在草原上要随时防备敌人，站着睡一有动静就能跑；家里的马也保留了这个习惯。" },
    { q:"蝙蝠为什么倒挂着睡觉？", a:"蝙蝠后脚小，倒挂让它松开就掉下去、立刻飞走，又安全又方便。" },
    { q:"苍蝇为什么那么难打？", a:"苍蝇的复眼能看到很大范围，脚上的细毛还能感觉到空气流动，我们手一动它就知道啦。" },
    { q:"刺猬身上为什么长满刺？", a:"刺是刺猬的护身符，遇到危险就缩成小球，硬刺让敌人不敢下口。" },
    { q:"牛为什么要反刍、嚼个不停？", a:"牛先把草匆匆吞下，躲起来再吐回嘴里慢慢嚼，这样吃草快、消化也好。" },
    { q:"鹦鹉为什么会学人说话？", a:"鹦鹉舌头灵活、耳朵又灵，爱模仿声音来求朋友；它虽不明白意思，却能学得挺像。" },
    { q:"蜜蜂为什么蜇人后会死？", a:"蜜蜂的刺上有倒钩，蜇完拔不出来，连内脏一起拉伤，所以它就牺牲了——所以它一般不随便蜇人。" },
    { q:"壁虎为什么能爬上墙？", a:"壁虎脚趾上有许多小细毛，能轻轻粘在墙上，像很多小手一样抓得牢。" },
    /* 自然 */
    { q:"露水是怎么来的？", a:"夜里草叶变凉，空气里的水汽碰到凉叶子，就凝成一颗颗小水珠，那就是露水。" },
    { q:"雾是怎么形成的？", a:"空气里水汽太多又变冷时，会凝成许多小水珠飘在靠近地面的地方，那就是雾。" },
    { q:"雪花为什么是六角形的？", a:"小冰晶喜欢按六边形的样子长，不管怎么变，基本都是六角，所以雪花大多有六个角。" },
    { q:"为什么会有回声？", a:"声音撞到远处的山或墙会弹回来，我们隔一会儿又听到，就像大山在学我们说话。" },
    { q:"海市蜃楼是怎么回事？", a:"沙漠或海面上方空气冷热不一样，光被弯了一下，把远处的景折到你眼前，像变魔术。" },
    { q:"风越大为什么越凉快？", a:"风把皮肤表面的热气和汗珠吹跑，热气一散，人就觉得凉快了。" },
    { q:"冰雹为什么会从天上掉下来？", a:"云里的小冰粒被上下乱流反复托起、结上一层又一层冰，变得太重了就掉下来，成了冰雹。" },
    { q:"闪电为什么弯弯曲曲？", a:"闪电专挑空气里最容易走的地方，要绕开干燥或不同的空气，所以走成了弯弯曲曲的线。" },
    { q:"一年为什么有 365 天？", a:"地球绕着太阳转一圈大约要 365 天，我们叫它一年，转完一圈就过完了一年。" },
    { q:"白天和黑夜是怎么来的？", a:"地球自己转圈圈，转到朝太阳的一面是白天，背过去的一面就是黑夜。" },
    { q:"彩虹为什么是七种颜色？", a:"阳光里本来就有红橙黄绿青蓝紫七色，穿过小水珠时被分开，就排成了七彩的彩虹。" },
    /* 人体 */
    { q:"我们为什么会打喷嚏？", a:"鼻子进了灰尘或闻到刺激味，身体就用打喷嚏这股大力气把脏东西喷出去，保护肺。" },
    { q:"手指泡水久了为什么会起皱？", a:"皮肤吸水变松会皱，这还能让我们在水里抓东西更牢，像轮胎的花纹一样。" },
    { q:"人为什么会流眼泪？", a:"眼泪能洗掉眼里的灰、保持湿润；伤心或切洋葱受刺激时，泪腺多分泌，眼泪就流出来啦。" },
    { q:"为什么我们要多运动？", a:"运动让心脏更有力、骨头更结实、个子长得高，还能让心情变开心。" },
    { q:"人为什么会起鸡皮疙瘩？", a:"冷或害怕时，小肌肉把汗毛立起来、留住热气；对人类没大用，但祖先毛发多时能保暖。" },
    { q:"口水（唾液）有什么用？", a:"口水先把食物弄湿好咽下，还能帮忙开始消化、杀死嘴里一些小细菌。" },
    { q:"人为什么要呼吸？", a:"我们吸进的氧气会跟着血跑到全身，帮身体把饭变成力气；没有氧气，几分钟就不行啦。" },
    { q:"人为什么会觉得痒？", a:"皮肤里有报警器神经，轻轻一碰就乱发信号，大脑分不清是危险还是玩笑，就觉得痒想笑。" },
    { q:"站久了脚为什么会发麻？", a:"长时间压着腿，血液和神经被压住，信号传得慢，脚就又麻又没知觉，活动一下就好。" },
    { q:"我们为什么要洗手？", a:"手上沾了看不见的小细菌，洗手用泡泡把它们冲走，就不容易把病菌吃进肚子里。" },
    { q:"人为什么会变老？", a:"身体细胞用久了会慢慢变弱，修复变慢，于是头发白、力气小，这就是变老。" },
    { q:"人为什么要长头发？", a:"头发像小帽子，能挡太阳、保暖，还能保护头皮不被轻轻碰到。" },
    /* 食物 / 植物 */
    { q:"爆米花是怎么爆开的？", a:"玉米粒里有一点点水，加热后水变成蒸汽把硬壳撑破，砰地变成白白胖胖的爆米花。" },
    { q:"切洋葱为什么会让人流泪？", a:"切洋葱时它放出刺激的气体，碰到眼睛就催泪，好像在说『别切我啦』。" },
    { q:"番茄是水果还是蔬菜？", a:"从植物上说它有籽、是水果；但我们常当菜炒着吃，所以它既是水果也是常吃的蔬菜。" },
    { q:"蘑菇为什么长在潮湿的地方？", a:"蘑菇没有叶绿素，不靠阳光；潮湿阴暗的地方有它要的营养和水分，所以爱在那长。" },
    { q:"大树为什么会长年轮？", a:"树在春天长得快、冬天长得慢，一圈圈疏密不同就是年轮；数圈圈就知道它几岁啦。" },
    { q:"含羞草为什么会合拢叶子？", a:"含羞草叶子受碰触会很快把水挪走，叶子就垂下来，这是它的自我保护，吓跑想吃它的虫。" },
    { q:"仙人掌为什么那么耐旱？", a:"仙人掌的身子能存很多水，刺代替叶子少蒸发，所以它很久不喝水也行。" },
    { q:"西瓜为什么那么甜？", a:"西瓜在藤上慢慢积累糖分，再加上水分多，咬一口又甜又解渴。" },
    { q:"菠菜里真的有很多铁吗？", a:"菠菜里有不少铁，能帮血液把氧气送到全身；不过也要搭配肉蛋，营养才全面。" },
    { q:"蜂蜜为什么放很久都不会坏？", a:"蜂蜜很甜很干，细菌难在里面活，密封好能放很久都不坏。" },
    { q:"蒸馒头为什么能变大？", a:"面团里的酵母放出小气泡，热气一蒸气泡胀大，馒头就变得松软胖乎乎。" },
    { q:"橘子为什么是一瓣一瓣的？", a:"橘子在妈妈肚子里本来是一小颗一小颗，长大黏成一团、外面裹层皮，就成了方便掰开的一瓣瓣。" },
    /* 科技 / 太空 */
    { q:"电脑为什么会「思考」？", a:"电脑不会真思考，它按人写的程序飞快算数、比大小，看起来就像在动脑筋。" },
    { q:"手机是怎么把声音传到远方的？", a:"说话变成电信号，再变成看不见的电波飞到对方手机，变回声音，千里之外也能聊。" },
    { q:"为什么 WiFi 看不见却能上网？", a:"WiFi 是用看不见的电波传数据，像空气里飞来飞去的小信使，把网页送到你眼前。" },
    { q:"手机和电视屏幕为什么能显示颜色？", a:"屏幕由无数小红绿蓝小点组成，它们亮暗不同，混在一起就变出千万种颜色。" },
    { q:"宇航员在太空里怎么睡觉？", a:"太空没上下，宇航员把自己绑在睡袋里飘着睡，免得睡着飘走撞到东西。" },
    { q:"火星为什么是红色的？", a:"火星土里有很多铁，像铁生锈一样变成红红色，所以远远看去火星是红的。" },
    { q:"天上的流星是怎么回事？", a:"小石头闯进大气层，和空气摩擦烧起来，划出一道光，我们叫它流星。" },
    { q:"为什么月亮好像总跟着人走？", a:"月亮离我们太远，我们走一点点它看起来还在老地方，就像远处的高楼总在身后陪着你。" },
    { q:"宇宙到底有多大？", a:"宇宙大得数不清，有好多好多的星星和银河，连科学家也还在慢慢探索呢。" },
    { q:"人造卫星为什么不会掉下来？", a:"卫星飞得又快又平，地球的引力刚好拉住它绕着转，就像甩绳上的小球不会飞走。" },
    { q:"望远镜为什么能看那么远？", a:"望远镜用大镜片把远处的光聚起来，让暗暗的远星变亮变大，我们就能看见啦。" },
    { q:"电池是怎么把电存起来的？", a:"电池里用药水和金属片，把电存起来；用的时候电就流出来，点亮小手电。" },
    { q:"相机为什么能拍下照片？", a:"相机用小孔让光照到感光片上，把光记下来，就成了永远留住的画面。" },
    { q:"为什么有的汽车不用汽油也能跑？", a:"电动车肚子里装大电池，电让马达转、车子跑，不用烧油，所以更干净安静。" },
    /* 生活 */
    { q:"镜子为什么能照出我们自己？", a:"镜子表面像平静的水，把照去的光按原路反射回来，进到我们眼睛，就看到了自己。" },
    { q:"肥皂为什么能洗掉油污？", a:"肥皂一头亲水、一头亲油，能把油滴裹成小团冲走，手就干净啦。" },
    { q:"冰箱为什么能让食物保鲜？", a:"冰箱里冷，让细菌长得慢、食物坏得慢，所以菜和肉能多放几天。" },
    { q:"氢气球为什么能飞上天？", a:"氢气比空气轻，像小泡泡托着气球往上飘；普通气球里是空气，要人吹才鼓。" },
    { q:"指南针为什么总指着北？", a:"地球像块大磁铁，指南针里的小针被地磁拉着，总有一头指向北边。" },
    { q:"衣服湿了为什么颜色变得更深？", a:"湿衣服纤维里进了水，光少反射、多被吸进去，看起来就更深更暗。" },
    { q:"剪刀为什么能剪断东西？", a:"剪刀两片刀交叉，手一捏就把东西夹断；尖尖还能先扎进布里。" },
    { q:"皮鞋为什么要经常擦油？", a:"鞋油填平小裂纹、挡住水，还能让皮子亮亮的、不容易干裂。" },
    { q:"玻璃为什么是透明的？", a:"玻璃里原子排得整齐，光几乎能直接穿过去不被挡，所以我们能看清对面。" },
    { q:"坐车为什么要系安全带？", a:"车突然停，人会往前冲；安全带把人拉住，不撞到前面，保护我们不受伤。" },
    { q:"微波炉为什么转一转就热了？", a:"微波让食物里的水分子快速抖动、互相摩擦生热，所以从里到外很快变热。" },
    { q:"气球为什么轻轻一扎就破？", a:"气球皮被撑得太薄太紧，轻轻一扎或见尖东西就裂开，空气一下冲出就啪地响。" },
    { q:"旗子为什么会迎风飘？", a:"风吹到旗子上，把布往一边推，旗子就跟着风飘呀飘。" },
    { q:"吸管为什么能吸上饮料？", a:"我们吸气让吸管里压力变小，杯子里的饮料就被外头的大气压压着升上来了。" }
  ];
